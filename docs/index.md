...
You can [download the current alpha version of JSVSynth
(version 0.0.1-2013102300)](http://www.xenoveritas.org/static/jsvsynth/jsvsynth-2013102300.zip).

Using the Plugin
----------------

For complete documentation, check out [the complete manual](manual.md).
